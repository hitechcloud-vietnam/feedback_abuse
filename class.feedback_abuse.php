...
class feedback_abuse extends OtherModule implements Observer
{
    ...
    protected $configuration = array(
        ...
        'allowed_extensions' => array(
            ...
            'value'       => self::DEFAULT_ALLOWED_EXTS,
            'default'     => self::DEFAULT_ALLOWED_EXTS,
        ),
        'max_file_size_mb' => array(
            'type'        => self::CONFIG_FIELD_INPUT,
            'label'       => 'Max upload size (MB)',
            'description' => 'Per-file cap. php.ini upload_max_filesize / post_max_size must be >= this.',
            'value'       => (string) self::DEFAULT_MAX_SIZE_MB,
            'default'     => (string) self::DEFAULT_MAX_SIZE_MB,
        ),
        'storage_path' => array(
            'type'        => self::CONFIG_FIELD_INPUT,
        ...
        'rate_limit_per_hour' => array(
            ...
            'value'       => (string) self::DEFAULT_RATE_LIMIT,
            'default'     => (string) self::DEFAULT_RATE_LIMIT,
        ),
        ...
        'embed_token_ttl' => array(
            ...
            'value'       => (string) self::EMBED_TOKEN_TTL,
            'default'     => (string) self::EMBED_TOKEN_TTL,
        ),
